      ...
      <div className="container contact_container">
        <div className="contact-options">
          ...
          <article className='contact-option'>
            <MdOutlineMail />
            <h4>Email</h4>
            <h5>baxsheliyevelvin@gmail</h5>
            <a href="mailto:baxsheliyevelvin@gmail" target='_blank'>Send a Message</a>
          </article>

          <article className='contact-option'>
            <RiMessengerLine />
            <h4>Facebook</h4>
            <h5>Elvin Baxsheliyev</h5>
          ...
          <article className='contact-option'>
            ...
            <h4>Whatsapp</h4>
            <h5>055-582-54-72</h5>
            <a href="https://wa.me/+994555825472" target='_blank'>Send a Message</a>
          </article>
        </div>
